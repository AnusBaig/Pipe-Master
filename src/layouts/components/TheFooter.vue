...
<template functional>
    <footer class="the-footer flex-wrap justify-between" :class="classes">
        <p>
          ...
          <a href="https://1.envato.market/vuexy_admin" target="_blank" rel="nofollow">Pipe Master</a>
          <span class="hidden sm:inline-block">, All rights Reserved</span>
        </p>
        <span class="md:flex hidden items-center">
            <span>Hand-crafted & Made by <b>Anus Baig [anasbaig12@outlook.com] </b> with</span>
